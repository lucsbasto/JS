...
// ?
    ...
    var username = prompt("Qual seu nome ?") || 'Desconhecido'; //curto circuito: se o lado esquerdo da expressão for false ele continua
...
*/
    $button.addEventListener('click', function(evt){
        ...
        if(!confirm("Deseja enviar o formulario ?"))
